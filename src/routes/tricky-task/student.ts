...
import { assignToStudent } from '#/services/trickyTask/index.js';
import { AppErrorSchema } from '#/utils/AppError.js';
import type { FastifyZodInstance } from '#/server.js';

export async function trickyTaskStudentRoutes (app: FastifyZodInstance) {
  app.post('/assign', {
