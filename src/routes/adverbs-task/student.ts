...
import { assignToStudent } from '#/services/adverbsTask/index.js';
import { AppErrorSchema } from '#/utils/AppError.js';
import type { FastifyZodInstance } from '#/server.js';

export async function adverbsTaskStudentRoutes (app: FastifyZodInstance) {
  app.post('/assign', {
